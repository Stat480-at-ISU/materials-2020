...
Load a sample of data from the [General Social Survey](http://gss.norc.org/) with the following code:
...
How many variables are there? Which type does each of the variables have?
