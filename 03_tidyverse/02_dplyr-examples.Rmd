...
- For each destination, compute the total minutes of delay. For each flight, compute the proportion of the total delay for its destination. <br><br> **Hint**: only include delayed flights when calculating the total delay and proportion of delay.
