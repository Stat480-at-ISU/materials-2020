...
- Compute `arr_hour` and `arr_min` from `arr_time`. (Hint: use modular arithmetic `%/%` for hour and `%%` for minute)  
...
- For each destination, compute the total minutes of delay. For each flight, compute the proportion of the total delay for its destination. (**Hint**: only include delayed flights when calculating the total delay and proportion of delay.)
