...
##### Find all Hall of Famers who were alive as of 2019. (use the data resulted from the joining done in question 1)
...
##### Join the two datasets to incorporate the release date of movies into the `box`  data.
